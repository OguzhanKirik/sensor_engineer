...
int main(int argc, const char *argv[])
{
	...
	bool bVis = false;
    std::string detectorType = "SHITOMASI";   //// -> HARRIS, FAST, BRISK, ORB, AKAZE, SIFT,SHITOMASI
   //std::string descType = "SHITHOMAIS";        //// -> HARRIS, FAST, BRISK, ORB, AKAZE, SIFT
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex++)
    {
        ...
        cout << " key point filtering: " << keypoints.size() << " keypoints in " << 1000 * t << " ms" << endl;
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            string descriptorT = "DES_BINARY";    // DES_BINARY, DES_HOG
